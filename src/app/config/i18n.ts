...
const resources = {
  en: {
    translation: {
        ...
        attachWheel: 'Add wheel',
        deatchWheel: 'Remove wheel',
        allMyRecords: 'All my records',
        editRecord: 'Edit record',
        newRecord: 'New Record',
        myWheelsEmpty: 'You have no wheels yet. Create your first wheel to get started!',
        wheelsEmpty: 'No wheels available.',
  ...
  ru: {
    translation: {
        ...
        wheelsEmpty: 'Колёс нет.',
        attachWheel: 'Добавить колесо',
        deatchWheel: 'Удалить колесо',
        allMyRecords: 'Все мои записи',
